...
function MovieInfo({movie}) {
    return (
        <div className='w-full xl:h-screen relative text-white'>
            ...
            {/*<img src={} alt={movie.name} className=''/>*/}
                        ...
                        <div className='flex flex-col gap-10'>
                            ...
                            <div className='grid grid-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg'>
                                ...
                                <div className='sm:col-span-2 col-span-3 flex justify-end font-medium text-sm'>
                                    <Link to={`/watch/${movie?.title}`} className='bg-dry py-4 hover:bg-subMain transitions border-2 border-subMain rounded-full flex-rows gap-4 w-full sm:py-3'>
