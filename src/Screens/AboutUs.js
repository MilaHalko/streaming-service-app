...
function AboutUs() {
    return (
        <Layout>
            ...
            <div className="px-8 mb-6 md:py-10 py-5 grid grid-flow-row xl:grid-cols-2 gap-5 xl:gap-16 items-center">
                <div>
                    ...
                    <div className='mt-5 text-sm leading-8 text-text space-y-5'>
                        ...
                        <p>
                            ...
                            streaming service offering online streaming from a library of films and television
                            series,
                ...
                <div className='mt-10 lg:mt-0'>
                    <img src="/images/cinemaPosters/charactersPoster.jpg" alt="Movie characters"
                         className='w-full rounded-lg xl:block hidden h-header object-cover'/>
                </div>
            </div>
        </Layout>
    )
